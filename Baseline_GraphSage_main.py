...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 16:51:44 2023

@author: d19_wujunhang
"""

#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 15:04:57 2023
...
class SAGE(nn.Module):
    def __init__(self, in_features, hidden_dim, out_dim):
        ...
        self.conv1 = dglnn.SAGEConv(in_feats=hidden_dim, out_feats=hidden_dim, aggregator_type='mean')
        self.conv2 = dglnn.SAGEConv(in_feats=hidden_dim, out_feats=out_dim, aggregator_type='mean')
        
    def forward(self, g, features):
        h = self.linear(features)
        h = self.conv1(g, h)
        h = F.relu(h)
        self.h = self.conv2(g, h)
        return self.h
...
parser.add_argument('--dataset', type=str, default="yelp", choices=['elliptic', 'yelp'], help='dataset')
...
net = SAGE(nfeats, args.hidden_dim, args.nclass)
